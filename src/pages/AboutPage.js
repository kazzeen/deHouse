      ...
      <Section>
        <Container>
          ...
          <Text size="18px" mb="32px">
            deHouse is a revolutionary Web3 platform that's core mission is to create a new system of truely decenterlized RWA ownership. Simply put deHouse is a DAO that connects donors with RWA ownership while leveraging blockchain technology for transparency and accountability.
          </Text>
      ...
      <Section style={{ backgroundColor: 'var(--bg-secondary)' }}>
        <Container>
          ...
          <Flex justify="center" wrap="wrap" gap="30px">
            ...
            <TeamMemberCard>
              <TeamMemberAvatar>RM</TeamMemberAvatar>
              <TeamMemberName>Richard Martinez </TeamMemberName>
