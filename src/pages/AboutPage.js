      ...
      <Section style={{ backgroundColor: 'var(--bg-secondary)' }}>
        <Container>
          ...
          <Flex justify="center" wrap="wrap" gap="30px">
            <TeamMemberCard>
              <TeamMemberAvatar>AK</TeamMemberAvatar>
              <TeamMemberName>Alex Kim</TeamMemberName>
            ...
            <TeamMemberCard>
              <TeamMemberAvatar>MJ</TeamMemberAvatar>
            ...
            <TeamMemberCard>
              <TeamMemberAvatar>DP</TeamMemberAvatar>
              <TeamMemberName>David Park</TeamMemberName>
